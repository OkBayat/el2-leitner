...
describe('ExerciseNodeComponent', () => {
  it('emits activation only for actionable states and exposes state semantics', () => {
    ...
    expect(button.disabled).toBe(false); expect(button.getAttribute('data-state')).toBe('available');
