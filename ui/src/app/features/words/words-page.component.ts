...
export class WordsPageComponent implements OnInit {
  ...
  async activate(word: LearningWord): Promise<void> { await this.store.activateWord(word); this.snack.open(`“${word.term}” was added to Box 1.`, 'OK', { duration: 2500 }); }
