...
- `k2-design-system`: mandatory before product-facing UI work. It owns the deterministic selection hierarchy for existing Vocora shared primitives, Angular Material, Angular CDK, Bootstrap utilities, shared tokens/styles, and minimal custom CSS, plus theme, accessibility, specificity, and touch-to-refactor rules.
